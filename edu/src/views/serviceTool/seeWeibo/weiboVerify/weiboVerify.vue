    ...
    <div class="weiboVerify" id="weiboVerify">
        <div class="form-wrap dark">
                ...
                <el-col :span="6">
                    <div class="avatar-uploader">
                        <div class="el-upload--text">
                            ...
                            <img :src="weiboInfo.microblogAvatar" class="avatar">
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="6">
                    <el-input v-model="weiboInfo.blogColleage" :disabled="true"></el-input>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                <el-col :span="4" class="text-right">所在地</el-col>
                <el-col :span="6">
                    <el-input v-model="weiboInfo.blogAddress" :disabled="true"></el-input>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                <el-col :span="4" class="text-right">所属院系</el-col>
                <el-col :span="6">
                    <el-input v-model="weiboInfo.belongDepartment" :disabled="true"></el-input>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                <el-col :span="4" class="text-right">简介</el-col>
                <el-col :span="6">
                    <el-input type="textarea" :rows="8" :disabled="true" v-model="weiboInfo.instruction"></el-input>
                </el-col>
            </el-row>
            <div class="line"></div>
            <el-row :gutter="20">
        ...
        methods:{
            ...
            submitInfo(){
                ...
                let param = {
                    ...
                    responsibleEmail: this.weiboInfo.responsibleEmail,
                    responsibleTel: this.weiboInfo.responsibleTel,
                    publishUser: this.weiboInfo.publishUser,
                    publishEmail: this.weiboInfo.publishEmail,
                    publishTel: this.weiboInfo.publishTel
                }
            ...
            verifyData(){
                //因为产品的需求修改  一下注释掉的代码都没用了   李菲挥泪写于2017-05-11  21:20
                let type = 'error';
                //名称校验
...
//                }else
            ...
            resetInfo(){
                this.weiboInfo.responsibleUser = null;
                this.weiboInfo.responsibleEmail = null;
                this.weiboInfo.responsibleTel = null;
                this.weiboInfo.publishUser = null;
                this.weiboInfo.publishEmail = null;
                this.weiboInfo.publishTel = null;
            },

            getBlogInfoData(){
                this.$http.post('/apis/businessTool/getMicroblogInfo.json', {id: this.weiboInfo.id}).then(
                    (response) => {
                        if(response.data.success){
