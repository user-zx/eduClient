...
<template>
    <div class="article-wrap myAttention-pomp" v-loading="loading" element-loading-text="加载中……">
        ...
        <articleView :articleData="articleData" class="dark" :total="total" :pageNumber="param.pageNumber"
                     :eventBtn="true" :unfollowBtn="true" @onchange="pageChange" ref="article"></articleView>
    </div>
</template>
<style>
