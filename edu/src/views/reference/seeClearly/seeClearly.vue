                    ...
                    <el-col :span="24">
                        <el-card class="educationBox box-card">
                            ...
                            <div class="col-item item-right">
                                <el-table :data="distributeData" :show-overflow-tooltip="true" style="width: 100%;" height="416" border class="tran-table no-col-title white-table-text fixed-table">
                ...
                <div class="article-wrap" v-loading="loading1" element-loading-text="加载中……">
                    ...
                    <div class="content dark">
                        ...
                        <el-table :data="tableData1" class="tran-table" border style="width: 100%"
                                  :resizable="false" @selection-change="handleSelectionChange1">
