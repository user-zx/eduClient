                ...
                <div class="top">
                    <div class="info">
                        ...
                        <div class="tree-node" v-for="item in nameListC[0].item">
                            <span>{{item.name}}</span>
                            <div class="checkbox">
                                <el-checkbox v-model=item.status :data-price=item.price class="price"
                ...
                <div class="middle">
                    <div class="info">
                        ...
                        <div class="input-wrap small">
                            <input type="text" name="" class="member-input" v-model="attention"
                                   @keyup="check_count($event,'school')" @blur="loseBlur">
                        </div>
                        500元/所
                    </div>
                    <div class="info">
                        可添加人物：
                        <div class="input-wrap small"><input type="text" name="" class="member-input" v-model="addition"
                                                             @keyup="check_count($event,'person')" @blur="loseBlur">
                        </div>
                        500元/人
                    </div>
                    <div class="info">
    ...
    export default{
        data(){
            return {
                ...
                item_b: ["行业动态", "人物动态", "媒体声誉", "两微洞察", "内参报告"],
                item_c: ["两微监管"],
...
//            },
            ...
            submit(){
                let arrData = [{
                    ...
                    itemNum: "",
                    item: []
                }, {name: "", price: "", time: "", concernCollegeNum: "", concernPersonNum: "", itemNum: "", item: []}];
