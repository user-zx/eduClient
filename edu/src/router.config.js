...
import briefDetails from './views/reference/report/reportDetails/briefDetails.vue';
import referenceDetails from './views/reference/report/reportDetails/referenceDetails.vue';
